...
public class ConsoleColors {
    ...
    public static void printMenu(String menu) {
        System.out.println(getMenuFormat(menu));
    }
    ...
    public static void printInput(String msg) {
        System.out.print(getInputFormat(msg));
    }

    public static String getMenuFormat(String msg) {
        return BLUE + msg + RESET;
    }

    public static String getInputFormat(String msg)
    {
